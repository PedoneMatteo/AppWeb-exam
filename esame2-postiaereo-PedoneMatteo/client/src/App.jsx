...
import { HomePage, DefaultLayout, NotFoundLayout, LoadingLayout } from './components/HomePage';
...
function App() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      checkAuth();
      API.getAirplanes().then(a => setAirplanes(a)).catch(err => handleErrors(err));
          ...
          <Container fluid>
            ...
            <Routes>
              <Route path='/' element={loading ? <LoadingLayout /> : <DefaultLayout />} >
                <Route index element={loading ? <LoadingLayout /> : <HomePage user={user} loggedIn={loggedIn} airplanes={airplanes} bookings={bookings} setBookings={setBookings} dirty={dirty} setDirty={setDirty} setMessage={setMessage} />} />
                <Route path='/airplane/:id_airplane' element={ <Airplane user={user} loggedIn={loggedIn} airplanes={airplanes} bookings={bookings} setBookings={setBookings} dirty={dirty} setDirty={setDirty} setMessage={setMessage} />} />
